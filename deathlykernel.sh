...
KERNEL="Image"
DTBIMAGE="dtb"
DEFCONFIG="cyanogenmod_ether_defconfig"
...
# Paths
KERNEL_DIR=`pwd`
REPACK_DIR="/1TB_HDD/Sean/caf/android_kernel_nextbit_msm8992"
MODULES_DIR="/1TB_HDD/Sean/caf/android_kernel_nextbit_msm8992/modules"
ZIP_MOVE="/1TB_HDD/Sean/caf/deathly/"
ZIMAGE_DIR="/1TB_HDD/Sean/caf/android_kernel_nextbit_msm8992/arch/arm64/boot"

# Functions
function clean_all {
		rm -rf $MODULES_DIR/*
		cd /1TB_HDD/Sean/caf/android_kernel_nextbit_msm8992/out/kernel
		rm -rf $DTBIMAGE
		cd $KERNEL_DIR
		echo
...
function make_boot {
		cp -vr $ZIMAGE_DIR/Image.gz-dtb /1TB_HDD/Sean/caf/android_kernel_nextbit_msm8992/out/kernel/zImage
		
}


function make_zip {
		cd /1TB_HDD/Sean/caf/android_kernel_nextbit_msm8992/out
